...
class TestParsing(unittest.TestCase):
    ...
    def test_compress_new_same_packet_twice(self):
        # from: https://datatracker.ietf.org/doc/html/rfc2118#section-4

        data = b"for whom the bell tolls, the bell tolls for thee.\xA6\x80"
        c = compression_mccp.MPPC(compression_mccp.MccpCompressionEncoder(compression_mccp.MccpCompressionConfig.RDP_40), 
                                    compression_mccp.MccpCompressionDecoder(compression_mccp.MccpCompressionConfig.RDP_40))
