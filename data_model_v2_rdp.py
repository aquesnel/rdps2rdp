...
class Rdp(object):
    ...
    @add_constants_names_mapping('TS_RAIL_SYSPARAM_', 'TS_RAIL_SYSPARAM_NAMES')
    @add_constants_names_mapping('TS_RAIL_SYSCOMMAND_', 'TS_RAIL_SYSCOMMAND_NAMES')
    ...
    class Rail(object):
        ...
        # note the following in the spec are actually SC_... or RAIL_SPI_...
        TS_RAIL_SYSCOMMAND_SC_SIZE = 0xF000
        TS_RAIL_SYSCOMMAND_SC_MOVE = 0xF010
        TS_RAIL_SYSCOMMAND_SC_MINIMIZE = 0xF020
        TS_RAIL_SYSCOMMAND_SC_MAXIMIZE = 0xF030
        TS_RAIL_SYSCOMMAND_SC_CLOSE = 0xF060
        TS_RAIL_SYSCOMMAND_SC_KEYMENU = 0xF100
        TS_RAIL_SYSCOMMAND_SC_RESTORE = 0xF120
        TS_RAIL_SYSCOMMAND_SC_DEFAULT = 0xF160

        # note the following in the spec are actually SPI_...
        # Client allowed values
        TS_RAIL_SYSPARAM_SPI_SETDRAGFULLWINDOWS = 0x00000025
        TS_RAIL_SYSPARAM_SPI_SETKEYBOARDCUES = 0x0000100B
        TS_RAIL_SYSPARAM_SPI_SETKEYBOARDPREF = 0x00000045
        TS_RAIL_SYSPARAM_SPI_SETWORKAREA = 0x0000002F
        TS_RAIL_SYSPARAM_RAIL_SPI_DISPLAYCHANGE = 0x0000F001
        TS_RAIL_SYSPARAM_SPI_SETMOUSEBUTTONSWAP = 0x00000021
        TS_RAIL_SYSPARAM_RAIL_SPI_TASKBARPOS = 0x0000F000
        TS_RAIL_SYSPARAM_SPI_SETHIGHCONTRAST = 0x00000043
        TS_RAIL_SYSPARAM_SPI_SETCARETWIDTH = 0x00002007
        TS_RAIL_SYSPARAM_SPI_SETSTICKYKEYS = 0x0000003B
        TS_RAIL_SYSPARAM_SPI_SETTOGGLEKEYS = 0x00000035
        TS_RAIL_SYSPARAM_SPI_SETFILTERKEYS = 0x00000033
        TS_RAIL_SYSPARAM_RAIL_SPI_DISPLAY_ANIMATIONS_ENABLED = 0x0000F002
        TS_RAIL_SYSPARAM_RAIL_SPI_DISPLAY_ADVANCED_EFFECTS_ENABLED = 0x0000F003
        TS_RAIL_SYSPARAM_RAIL_SPI_DISPLAY_AUTO_HIDE_SCROLLBARS = 0x0000F004
        TS_RAIL_SYSPARAM_RAIL_SPI_DISPLAY_MESSAGE_DURATION = 0x0000F005
        TS_RAIL_SYSPARAM_RAIL_SPI_CLOSED_CAPTION_FONT_COLOR = 0x0000F006
        TS_RAIL_SYSPARAM_RAIL_SPI_CLOSED_CAPTION_FONT_OPACITY = 0x0000F007
        TS_RAIL_SYSPARAM_RAIL_SPI_CLOSED_CAPTION_FONT_SIZE = 0x0000F008
        TS_RAIL_SYSPARAM_RAIL_SPI_CLOSED_CAPTION_FONT_STYLE = 0x0000F009
        TS_RAIL_SYSPARAM_RAIL_SPI_CLOSED_CAPTION_FONT_EDGE_EFFECT = 0x0000F00A
        TS_RAIL_SYSPARAM_RAIL_SPI_CLOSED_CAPTION_BACKGROUND_COLOR = 0x0000F00B
        TS_RAIL_SYSPARAM_RAIL_SPI_CLOSED_CAPTION_BACKGROUND_OPACITY = 0x0000F00C
        TS_RAIL_SYSPARAM_RAIL_SPI_CLOSED_CAPTION_REGION_COLOR = 0x0000F00D
        TS_RAIL_SYSPARAM_RAIL_SPI_CLOSED_CAPTION_REGION_OPACITY = 0x0000F00E
        # Server allowed values
        TS_RAIL_SYSPARAM_SPI_SETSCREENSAVEACTIVE = 0x00000011
        TS_RAIL_SYSPARAM_SPI_SETSCREENSAVESECURE = 0x00000077
